...
var SpeedMeter = function(SensorPin, levelUpPin, levelDownPin, resistUpPin, resistDownPin, weighting, pulsesPerRev, timeOut, bounceTime) {
  ...
  var power = [
    ...
    [9,20,32,47,66,84,107,125,148,172,186],    // Level 1
    ...
    [21,46,77,113,157,199,245,295,345,386,442], // Level 8 (0% grade)
    ...
    [42,91,153,223,313,385,461,574,645,720,840], // Level 20
